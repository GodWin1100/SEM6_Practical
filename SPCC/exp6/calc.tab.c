...
{
      12,     0,    -1,    13,    -1,    13,     4,    13,    -1,    13,
       5,    13,    -1,    13,     6,    13,    -1,    13,     7,    13,
      -1,    13,     8,    13,    -1,     9,    13,    10,    -1,     3,
      -1
};
...
static const char *const yytname[] =
{
  ...
  "'%'", "'('", "')'", "$accept", "ArithmeticExpression", "E", YY_NULL
};
#endif
...
void main(){
printf("\nEnter Any Arithmetic Equation which can have operations Addition, Subtraction, Multiplication, Division, Modulus and Round brackers:\n");
yyparse();
if(flag==0)
